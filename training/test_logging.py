...
def test_loggin():
    ...
    trainer = MultimodalTrainer(
        model=model, train_loader=mock_loader, val_loader=mock_loader
    )
    ...
    val_lossess = {"total": 1.5, "emotion": 0.5, "sentiment": 1.0}
    val_metrics = {
    ...
    trainer.log_metrics(val_lossess, val_metrics, phase="val")
